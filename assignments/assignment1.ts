...
console.log ("Whether a customer has placed an order:"  + true);
...
console.log ("Person's marital status:" + marital);
...
const eye: string = "Brown";
console.log ("Person's eye color: " + eye);
