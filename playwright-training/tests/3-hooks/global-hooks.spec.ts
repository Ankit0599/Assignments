...
test.beforeAll(async () => {
    console.log("******Global Before all : This runs before all the test cases.******");
});

test.afterAll(async () => {
    console.log("******Global After all : This runs After all the test cases.******");
});

test.beforeEach(async () => {
    console.log("-------Global Before Each : This runs before each the test cases.-------");
});

test.afterEach(async () => {
    console.log("-------Global After Each : This runs after each the test cases.-------");
});
